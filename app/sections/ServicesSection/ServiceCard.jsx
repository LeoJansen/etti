...
const ServiceCard = ({ imageSrc, imageAlt, title, description }) => {
  return (
    <div className="service-card flex flex-col  p-6 md:p-0 md:py-6 items-center h-full w-full  rounded-[6px]  duration-300  gap-6 md:gap-0  bg-[#040404] z-10 ">
      ...
      <div className='w-full h-full xl:w-3/4 flex flex-col gap-8 justify-center items-center  rounded-[6px] p-8 md:px-0 md:py-2'>
        <div className='h-10 w-full flex flex-col justify-center text-[20px] text-[#EB9948] font-normal text-center drop-shadow-[_1px_1px_2px_rgba(240,240,255,0.55)] leading-6'>
