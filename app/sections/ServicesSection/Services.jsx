   ...
   return (
      <section id="services" className=" hidden md:flex relative   w-full min-h-screen max-w-screen overflow-hidden">
         ...
         <div className="flex flex-col w-full h-full  ">
            <div className='flex w-full h-1/2 justify-end items-center border-4 border-blue-500 '>
            ...
            <div className="w-full h-1/2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8  px-10  py-20 text-[#cecece]  border-purple-500">
