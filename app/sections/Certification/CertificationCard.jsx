...
const CertificationCard = ({ title, description, image, index }) => {
   return (
      <div id={`certification-card-${index}`} className="relative flex w-full h-full justify-center items-center  rounded-[6px] p-10  gap-8 xl:gap-12" style={{ boxShadow: "0 0 60px 3px rgba(23, 15, 7, 0.07)" }}>
