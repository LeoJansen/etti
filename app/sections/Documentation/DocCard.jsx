...
const DocCard = ({  title, description, icon,  iconSize }) => {
  ...
  return (
    <div className="flex flex-col  items-center h-full self-end max-w-[500px]  w-full  rounded-[2px]  duration-300 py-4  gap-2 md:gap-0 p-4 bg-[#e4e4e4] backdrop-blur-[40px] shadow-[0_2px_4px_2px_rgba(20,20,20,0.15)] z-10 ">
      <div className='flex w-full justify-start items-center   '>
        ...
        <Image
            ...
            className='mx-auto brightness-0 opacity-[0.535] '
          />
