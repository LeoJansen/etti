      ...
      <div className=" flex flex-col w-full h-full items-center justify-center  px-4 md:px-8 lg:px-16">
        ...
        <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8 lg:px-10 lg:py-20 text-[#b1b4b9] ">
          ...
          <div className="metalicCards flex p-6  items-center h-full rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2c2f33] ">
            ...
            <div className='w-full xl:w-3/4 flex flex-col pr-0 lg:pr-16 gap-8  h-full justify-stretch'>
              <div className='h-10 w-full flex justify-center '>
                <h3 className="text-2xl font-semibold   text-image">Instalações Elétricas</h3>
              </div>
              <div className='bg-[#151618] flex w-full h-full rounded-[8px] p-4 text-[#858991]'>
                   <p className="text-justify text-[18px] font-regular ">
          ...
          <div className="metalicCards flex p-6  items-center  h-full rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2c2f33] ">
            ...
            <div className='w-full xl:w-3/4 flex flex-col pr-0 lg:pr-16 py-5 lg:py-10 h-full justify-stretch'>
              <div className='h-10 w-full flex justify-center'>
                <h3 className="text-2xl font-semibold  mb-2 text-image">Sistemas de Segurança</h3>
              </div>
          ...
          <div className="metalicCards flex  p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2c2f33]">
            ...
            <div className='w-full xl:w-3/4 flex flex-col pr-0 lg:pr-16 py-5 lg:py-10 h-full justify-stretch'>
              <div className='h-10 w-full flex justify-center'>
                <h3 className="text-2xl font-semibold  mb-2 text-image">Automação Residencial</h3>
              </div>
              <p className="text-justify">
          ...
          <div className="metalicCards flex p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2c2f33]">
            ...
            <div className='w-full xl:w-3/4 flex flex-col pr-0 lg:pr-16 py-5 lg:py-10 h-full justify-stretch'>
              <div className='h-10 w-full flex justify-center'>
                <h3 className="text-2xl font-semibold  mb-2 text-image">Certificação Técnica</h3>
              </div>
              <p className="text-justify">
