        ...
        <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-8 lg:px-10 lg:py-20 text-[#b1b4b9] ">
          ...
          <div className="metalicCards flex flex-col md:flex-row p-6  items-center h-full w-full rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2c2f33] gap-6 md:gap-0">
            ...
            <div className='w-full h-full xl:w-3/4 flex flex-col gap-8   justify-center items-center bg-[#151618] rounded-[8px]  p-8'>
              <div className='h-10 w-full flex flex-col justify-center text-2xl font-normal text-center drop-shadow-[_1px_1px_12px_rgba(255,255,200,0.85)]'>
          ...
          <div className="metalicCards flex flex-col md:flex-row p-6  items-center  h-full w-full  rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2c2f33] gap-6 md:gap-0">
            <div className='flex w-full xl:w-1/4 justify-center items-start'>
             ...
             <div className='h-10 w-full flex flex-col justify-center text-2xl font-normal text-center tracking-wide drop-shadow-[_1px_1px_12px_rgba(255,255,200,0.85)]'>
                <h3 >Sistemas de</h3>
                <h3 >Segurança</h3>
              </div>
          ...
          <div className="metalicCards flex flex-col md:flex-row p-6 rounded-lg h-full w-full  items-center shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#2c2f33] gap-6 md:gap-0">
            <div className='flex w-full xl:w-1/4 justify-center items-start'>
